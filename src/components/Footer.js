...
pv4 ph3 ph5-m ph6-l mid-gray ${props => props.home ? 'fixed left-0 bottom-0 right-0 z-1' : 'w-100 wrap'}
`
  ...
  return (
    <FooterWithMatch>
      ...
      <div className="tc pt3">
        <a className="link mid-gray dib h2 w2 mr3" href="https://linkedin.com/in/ajmalafif" target="_blank" rel="noopener noreferrer" title="LinkedIn">
        ...
        <a className="link mid-gray dib h2 w2 mr3" href="https://github.com/ajmalafif" target="_blank" rel="noopener noreferrer" title="GitHub">
        ...
        <a className="link mid-gray dib h2 w2 mr3" href="https://twitter.com/ajmalafif" target="_blank" rel="noopener noreferrer" title="Twitter">
      ...
      <a className="link mid-gray dib h2 w2" href="https://codepen.io/ajmalafif" target="_blank" rel="noopener noreferrer" title="CodePen">
