...
title: 'Include external JavaScript into Roots'
...
Then, open `scripts.php` inside `wp-content/themes/roots/lib/`
...
function roots_scripts() {
  ...
  wp_register_script('backstretch', '/assets/js/vendor/jquery.backstretch.min.js', false, null, false);
